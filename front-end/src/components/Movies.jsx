                    ...
                    <li key={i} className="self-start">
                        <button>
                            <img
                                ...
                                alt="movie poster"
                            />
                            <div className=" relative top-[-50px] left-2  ratings bg-[#7EE084] font-bold font-[Mypoppins] backdrop-blur-md h-[39px] w-[46px] text-center flex justify-center items-center rounded-[5px] ">{movie.rating}</div>
                        </button>
