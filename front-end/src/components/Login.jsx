    ...
    <div className="min-h-screen w-full flex items-center justify-center">
      <div className="relative flex flex-col sm:flex-row items-center justify-center min-h-screen w-full">
        ...
        <div className="relative  z-10 bg-[#000000]/70 backdrop-blur-lg p-8 rounded-xl shadow-2xl max-w-[450px] w-full">
          <h3 className="text-xs font-regular text-white mb-2 uppercase">LET'S GET YOU STARTED</h3>
          <h1 className="text-xl font-bold text-white mb-4 uppercase ">Log in to Get Started</h1>
          ...
          <form onSubmit={handleLogin} className="w-full flex flex-col gap-4">
            ...
            <button className="bg-[#0DBC87] cursor-pointer tracking-[2px] text-white p-3 rounded-lg hover:bg-[#00AB77] transition font-semibold">
              GET STARTED
            </button>
          </form>
          ...
          <div className="max-sm:text-[12px]  mt-5 text-center text-white/90">
            Don't have an account? <a className="text-[#00AB77] cursor-pointer" href="/signup">Sign Up</a> here.
          </div>
        </div>
      </div>
    </div>
