...
import { useAuth } from "../AuthContext"; // Importing AuthContext // Import AuthContext
    ...
    <div className="m-0 p-0 relative z-50 font-[Mypoppins]">
      <nav className="flex items-center bg-[#153F29] justify-between h-16 rounded-xl m-2 p-4 relative md:h-20">
        ...
        >
          ...
          {/* Search Bar & Auth Buttons inside dropdown on small screens */}
          {menuOpen && (
        ...
        {/* Search Bar & Auth Buttons for larger screens */}
